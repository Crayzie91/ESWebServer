...
#include "../../lwip/inc/lwip/init.h"
#include "../../lwip/inc/lwip/memp.h"
#include "../../lwip/inc/lwip/netif.h"
#include "../../lwip/inc/lwip/opt.h"
#include "../../lwip/inc/lwip/sys.h"
#include "../../lwip/inc/lwip/tcpip.h"
#include "../../lwip/inc/lwip/timers.h"
#include "../../lwip/inc/netif/etharp.h"

#if LWIP_DHCP
#include "../../lwip/inc/lwip/dhcp.h"
#endif

#include <string.h>
#include "board.h"
#include "lpc_phy.h"
#include "../../lwip/inc/arch/lpc17xx_40xx_emac.h"
#include "../../lwip/inc/arch/lpc_arch.h"
#include "../../lwip/inc/arch/sys_arch.h"
...
static void vSetupIFTask(void *pvParameters) {
	...
	DEBUGSTR("\x1b[2J\x1b[H");//ClearScreen
