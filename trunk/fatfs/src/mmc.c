...
#define CS_LOW() Chip_GPIO_WritePortBit(LPC_GPIO, 2, 2, false)
#define CS_HIGH() Chip_GPIO_WritePortBit(LPC_GPIO, 2, 2, true)
...
)
{
	...
	Chip_GPIO_WriteDirBit(LPC_GPIO, 2, 2, true); /* CS */
	Chip_GPIO_WriteDirBit(LPC_GPIO, 2, 11, false); /* Card Detect */
